...
const tabs = [
  ...
  { path: '/transactions', label: 'Activity', icon: TransactionsIcon },
  { path: '/forecast', label: 'Forecast', icon: ForecastIcon },
  { path: '/settings', label: 'Settings', icon: SettingsIcon },
]

export function CupertinoTabBar() {
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[520px] bg-ios-card/80 dark:bg-ios-card/80 backdrop-blur-xl border-t border-ios-separator z-50"
